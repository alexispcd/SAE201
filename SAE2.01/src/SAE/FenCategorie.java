...
public class FenCategorie extends Stage {
	...
	private Tooltip					tooltipAjouter	 = new Tooltip("Ajouter une catégorie");
	private Tooltip					tooltipModifier	 = new Tooltip("Modifier une catégorie");
	private Tooltip					tooltipSupprimer = new Tooltip("Supprimer une catégorie");
	private Tooltip					tooltipReservation = new Tooltip("Afficher les réservations");
	...
	private Parent creerContenu() {
		...
		bnAjouter.setTooltip(tooltipAjouter);
		bnModifier.setTooltip(tooltipModifier);
		bnSupprimer.setTooltip(tooltipSupprimer);
		bnReservation.setTooltip(tooltipReservation);
